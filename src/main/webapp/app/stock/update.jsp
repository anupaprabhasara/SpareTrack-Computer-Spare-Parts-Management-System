...
<head>
    ...
    <title>Edit Transaction #${stock.transactionId} | MediSync</title>
...
<main class="flex-1 p-6">
    <h1 class="text-3xl font-bold text-gray-700 dark:text-gray-200 mb-6">
        <i class="fa-solid fa-boxes-stacked"></i> Edit Transaction #${stock.transactionId}
    </h1>
    ...
    <div class="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-lg">
        <form action="stock" method="POST" class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <input type="hidden" name="id" value="${stock.transactionId}">
            ...
            <div>
                ...
                <select name="medicineId" required
                    ...
                    <c:forEach var="medicine" items="${medicines}">
                        <option value="${medicine.medicineId}" ${stock.medicineName == medicine.name ? 'selected' : ''}>
                            ${medicine.name}
                        </option>
                    </c:forEach>
                </select>
            ...
            <div>
                ...
                <select name="transactionType" required
                        class="w-full px-4 py-2 mt-2 border dark:border-gray-600 rounded-lg focus:outline-none focus:ring-1 focus:ring-orange-500/50 dark:bg-gray-700 dark:text-white">
                    <option value="Stock-In" ${stock.transactionType == 'Stock-In' ? 'selected' : ''}>Stock-In</option>
                    <option value="Stock-Out" ${stock.transactionType == 'Stock-Out' ? 'selected' : ''}>Stock-Out</option>
                </select>
            </div>
            ...
            <div>
                ...
                <input type="number" name="quantity" value="${stock.quantity}" required min="1"
                       class="w-full px-4 py-2 mt-2 border dark:border-gray-600 rounded-lg focus:outline-none focus:ring-1 focus:ring-orange-500/50 dark:bg-gray-700 dark:text-white">
            </div>
