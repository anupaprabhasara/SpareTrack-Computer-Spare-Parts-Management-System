...
<head>
    ...
    <title>Edit ${supplier.name} | MediSync</title>
...
<main class="flex-1 p-6">
    <h1 class="text-3xl font-bold text-gray-700 dark:text-gray-200 mb-6">
        <i class="fa-solid fa-truck"></i> Edit ${supplier.name}
    </h1>
    ...
    <div class="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-lg">
        <form action="supplier" method="POST" class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <input type="text" name="contact_info" value="${supplier.contactInfo}" required
                    class="w-full px-4 py-2 mt-2 border dark:border-gray-600 rounded-lg focus:outline-none focus:ring-1 focus:ring-orange-500/50 dark:bg-gray-700 dark:text-white">
            </div>
            ...
            <div class="md:col-span-2">
                ...
                <textarea name="address" required
                    class="w-full min-h-16 px-4 py-2 mt-2 border dark:border-gray-600 rounded-lg focus:outline-none focus:ring-1 focus:ring-orange-500/50 dark:bg-gray-700 dark:text-white">${supplier.address}</textarea>
            </div>
