...
<head>
    ...
    <title>Edit ${user.name} | MediSync</title>
...
<main class="flex-1 p-6">
    <h1 class="text-3xl font-bold text-gray-700 dark:text-gray-200 mb-6">
        <i class="fa-solid fa-users-gear"></i> Edit ${user.name}
    </h1>
    ...
    <div class="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-lg">
        <form action="user" method="POST" class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="md:col-span-2 flex justify-between mt-6">
                ...
                <button id="submitButton" type="submit" class="bg-orange-500 text-white px-6 py-2 rounded-lg hover:bg-orange-600 transition disabled:opacity-50 disabled:cursor-not-allowed">
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    // Check password validity on page load
    validatePassword();
