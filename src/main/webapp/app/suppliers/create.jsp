...
<head>
    <meta charset="UTF-8">
    <title>Create Supplier | SpareTrack</title>
...
<main class="flex-1 p-6">
    <h1 class="text-3xl font-bold text-green-700 mb-6">
        <i class="fa-solid fa-truck-medical"></i> Create Supplier
    </h1>
        ...
        <form action="supplier" method="POST" class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="md:col-span-2">
                ...
                <textarea name="address" rows="3" required
                    class="w-full px-4 py-2 border border-green-300 rounded focus:outline-none focus:ring-2 focus:ring-green-400 resize-none"></textarea>
            </div>
